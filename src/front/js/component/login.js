    ...
    return (
        ...
        <div className="form_container my-5">
            <figure className="logo_container">
                <img alt="Sharguidev" src="https://github.com/4GeeksAcademy/Authentication-System-Sharguidev/blob/main/src/front/img/5.png?raw=true" />
            </figure>
            ...
            <div className="input_container">
                ...
                <input placeholder="name@mail.com" title="Inpit title" name="input-name" type="text" className="input_field" id="email_field" onChange={(e) => setUser({ ...user, email: e.target.value })} />
            </div>
            <div className="input_container">
                ...
                <input placeholder="Password" title="Inpit title" name="input-name" type={showPassword ? "text" : "password"} className="input_field" id="password_field" onChange={(e) => setUser({ ...user, password: e.target.value })} />
                <div id="togglePassword" onClick={() => setShowPassword(!showPassword)}>{showPassword ? <i className="fa-regular fa-eye-slash"></i> : <i className="fa-regular fa-eye"></i>}</div>
            </div>
            <button title="Sign In" type="submit" className="sign-in_btn mt-3" onClick={() => {
            ...
            <Link to="/register" className="w-100" style={{ textDecoration: "none" }}>
                <button title="Sign In" type="submit" className="sign-in_apl w-100">
