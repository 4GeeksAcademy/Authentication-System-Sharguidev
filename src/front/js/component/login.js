    ...
    return (
        ...
        <div className="form_container my-5">
            ...
            <div className="input_container">
                ...
                <input placeholder="Password" title="Inpit title" name="input-name" type={showPassword ? "text" : "password"} className="input_field" id="password_field" />
            ...
            <button title="Sign In" type="submit" className="sign-in_btn mt-3">
                <span>Let's go</span>
            </button>
